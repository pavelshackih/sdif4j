package org.sdif4j.testing.pico;
...
import org.sdif4j.pico.PicoInjector;
...
public class PicoTest {
	...
	public void beforeClass() {
		...
		final PicoInjector picoInjector = picoContainer.getComponent(PicoInjector.class);
		assertTrue(picoInjector.getPicoContainerAccessor() == picoContainer);

		final PicoInjector picoInjector1 = picoContainer.getComponent(PicoInjector.class);
		// fail
	...
	private MutablePicoContainer createPicoContatiner() {
		...
		picoContainer.as(Characteristics.CACHE).addComponent(PicoInjector.class);
	...
	public void testInjectorInstance() {
		...
		assertTrue(injector1 instanceof PicoInjector);
